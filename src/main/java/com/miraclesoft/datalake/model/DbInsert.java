...
public class DbInsert {
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "dbinsert_seq")
    @GenericGenerator(
        name = "dbinsert_seq", 
        ...
        parameters = {
            ...
            @Parameter(name = StringPrefixedSequenceIdGenerator.VALUE_PREFIX_PARAMETER, value = "DB_"),
	...
	public DbInsert(String connectionName, String dbtype, String hostAddress, String portnumber, String dbname,
